  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-4 md:px-8">
        ...
        <button
          className="aspect-square rounded-xl border-2 border-gray-300 bg-white/80 hover:bg-red-50 transition-all duration-300 flex flex-col items-center justify-center shadow-sm hover:shadow-md group relative overflow-hidden"
          onClick={() => navigate("/N3Additional")}
        >
          <span className="text-5xl font-extrabold mb-2 text-red-500 group-hover:text-red-600 transition-colors duration-200">N3補充</span>
          <span className="text-lg font-bold text-gray-700  tracking-wide">單字練習</span>
        </button>
        <button
